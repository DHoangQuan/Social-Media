...
$(window).load(function () {
  $('.cancelinput').attr('autocomplete', 'off'); // $('.cancelinput').val('');

  $('.inputbody').attr('autocomplete', 'off'); // $('.inputbody').val('');
});
...
/******/ });
//# sourceMappingURL=application-5b1f56e253078f868a96.js.map